...
|  Cerca   |      |
| :---: | :---: |
| Cerchi una spiaggia a Mykonos? Un ombrellone per ripararti dal caldo della Corsica? Uno sdraio per riposare sul lago di Garda? Abbiamo la spiaggia che fa per te, basta cercare!  |   ![](assets/image8.png)  |

|    |  Confronta    |
| :---: | :---: |
| ![](assets/image19.png) | Puoi confrontare i migliori lidi in Europa, e scoprire se organizzano tornei di beach volley. Noi ti aiutiamo a trovare quello che fa al caso tuo.|

|  Viaggia  |    |
| :---: | :---: |
| Non importa da dove arrivi o quale sia la tua meta: chiunque può registrarsi e prenotare in pochi click. Da smartphone, tablet o pc.|![](assets/image1.png)|
...
![](assets/image20.png)[Schema completo](https://www.google.com/url?q=https://drive.google.com/file/d/19wG2Kp4pJ1i3h-K1S_ukSWLxcUL0V9-g/view?usp%3Dsharing&sa=D&ust=1595329645257000&usg=AOvVaw0ayTbZwDrZhO2skBQlfC_A)
...
Tutti i dati sono conservati nel rispetto della privacy degli utilizzatori secondo le norme Europee del [GDPR](https://www.google.com/url?q=https://www.privacy-regulation.eu/it/&sa=D&ust=1595329645258000&usg=AOvVaw2kHwj6zIjkGpOD9yf7rO6m).
...
[Schema completo](https://www.google.com/url?q=https://drive.google.com/file/d/1PwGG0F34Fqp_PSOwHo-RPfLnFzvL65QI/view?usp%3Dsharing&sa=D&ust=1595329645272000&usg=AOvVaw1X4M0jvX_D-gKjo7ffm5hN)
...
CLIENTE(ID, ID_Salute, ID_Ospite, Nome, Cognome, Mail, Password, Data_Nascita, Residenza)

ID -> Nome, Cognome, Mail, Password, Data_Nascita, Residenza

FK ID_Salute REFERENCES STATO_SALUTE.ID

FK ID_Ospite REFERENCES CLIENTE.ID
...
STATO_SALUTE(ID, Colore, Accettato, Rimborso)
...
PRENOTAZIONE(ID, ID_Cliente, ID_Stato, Data_Inizio, Data_Fine)
...
POSTO(ID, ID_Stabilimento, Nome, Prezzo_Ora, Numero_Serie, Colore, Capienza)
...
STABILIMENTO_BALNEARE(ID, Nome, Descrizione, Capienza, Coordinate)
...
STABILIMENTO_SERVIZIO(ID_Stabilimento, ID_Servizio)

FK ID ID_Stabilimento REFERENCES STABILIMENTO.ID

FK ID_Servizio REFERENCES SERVIZIO.ID

SERVIZIO(ID, Nome, Descrizione)



## Funzioni

In questa sezione verranno illustrate alcune funzionalità dell’app, con riferimento ad alcuni porzioni di codice che ne permettono il funzionamento. Il codice completo è visibile dalla [repository](https://www.google.com/url?q=https://github.com/defending1/suntan&sa=D&ust=1595329645292000&usg=AOvVaw3pGaZ9rQ1iMr0DVzyP_PVc) o dall’archivio in allegato.
...
|  Pagina |  Codice |
| :---:| :---: |
|![](assets/image7.jpg)|[Codice](https://www.google.com/url?q=https://github.com/defending1/suntan/blob/master/client/src/components/Subscribe/Form/index.js&sa=D&ust=1595329645294000&usg=AOvVaw2Xg4WnNkevu5BijSO6mGWR)|
...
 const received = { ID: null, ID_Salute: null, ID_Ospite: null, Nome: data.Nome, Cognome: data.Cognome, Mail: data.Mail, Password: data.Password, Data_Nascita: data.Data_Nascita, Residenza: data.Residenza,  
 };  
...
    mail VARCHAR (50) NOT NULL, password VARCHAR (50) NOT NULL,  
...
Il numero identificativo viene assegnato automaticamente dal database attraverso la funzione AUTO_INCREMENT.
...
|  Cliente  | Operatore  |
| :---:  | :---: |
|![](assets/image11.jpg)|![](assets/image6.jpg)|
